## Analyse d'une question ouverte au moyen de l'AGD
## QuantiLille 2023 Module 1
## B. Garnier (Ined)
## extrait des réponses à une question ouverte issue de l’enquête "Population, Espace de Vie, Environnement" (Ined, 1992)
...
explor(resTLE)
## Fermer la fenetre Shiny pour lancer la suite des calculs
...
## ----AFC_TLA---------------------------------------------
resTLA<-corpus_ca(corpus,dtm, variables =c("sexe","aget","matrim","pratique","enf","activite","prof","vote","habitat","localite","revenu"),sparsity=0.98)
explor(resTLA)
...
## ----tree,, eval=FALSE-----------------------------------
## arbre <- terms_graph(dtmlem2, min_occ = 30, interactive=T)
